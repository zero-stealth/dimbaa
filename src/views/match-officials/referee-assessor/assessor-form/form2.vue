...
onMounted(async () => {
  const options = {
    method:"POST",
    url: "https://be-tblp.dimbaa.com/api/referee-assessor/referee-evaluation/game-control",
    headers: {
...
<template>
  <div class="assess-container">
    <h2>Evaluation of the referee</h2>
    <div class="assess-inner">
      <div class="assess-wrapper">
        <div class="assess-i">
          <h1>Control of the game</h1>
          <li>
            <ol>
              <p>
                Correct and consistent interpretion and application of the law
                of the game +D46
              </p>
              <p>
                Appropriate disciplinary sanctions, tactcal approach and
