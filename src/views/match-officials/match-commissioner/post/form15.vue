<script setup>
import work from "./form15/work.vue";
import match from "./form15/match.vue";
import accuracy from "./form15/accuracy.vue";
import position from "./form15/position.vue";
import { usePostStore } from "@/stores/post";
import { useDrawerStore } from "@/stores/drawer";
import personality from "./form15/personality.vue";
...
<template>
  <div class="post-wr2">
    <div class="wr2-p">
      <h1>2nd Assistant Referee Perfomance</h1>
