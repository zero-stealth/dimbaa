...
import CreateFormation from "@/components/form/createform/CreateFormation.vue";
...
const searchResult = computed(() => {
  return data.value.filter((d) => d.jersey_number.includes(search.value));
});
    ...
    <div class="user-content" v-else>
      ...
      <div class="table-slide">
        <table>
          ...
          <tr
            v-for="({ first_name, middle_name, jersey_number, formation, number, role }, index) in searchResult"
            :key="index"
          >
        ...
        <div class="sort-wrapper">
          ...
          <div class="sort-user-i">
            <div class="sort-label-i">
              <label for="user-role">Player Role</label>
              <input
                type="radio"
                v-bind:value="false"
              />
            ...
            <div class="sort-label-i">
              <label for="username">Formation</label>
              <input
                type="radio"
                v-bind:value="false"
              />
