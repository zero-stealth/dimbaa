...
const playerSpecific = (pos) => {
  routeStore.setPlayer(pos);
      ...
      <div class="team-player-x" v-for="(
        ...
        <div class="team-d-x">
          <img
            ...
            alt="team-logo" class="team-logo-x" />
          ...
          <div class="stad-cd">
            ...
            <a @click="playerSpecific(playing_position)" class="stad-cd-d">View</a>
          </div>
        </div>
