...
<template>
  <div class="main-container">
    ...
    <div class="data-content-r">
      <!-- data nav  -->
      <div class="data-nav">
        <button class="data-n-b" @click="dataPage = upcoming" :class="[dataPage == upcoming ? 'datapage' : '']">
          Upcoming
        </button>
        <button class="data-n-b" @click="dataPage = current" :class="[dataPage == current ? 'datapage' : '']">
          Current
        </button>
        <button class="data-n-b" @click="dataPage = history" :class="[dataPage == history ? 'datapage' : '']">
          History
        </button>
      </div>
    </div>
